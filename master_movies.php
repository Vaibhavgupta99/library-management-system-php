...
$result = mysqli_query($conn, "SELECT * FROM books_tb WHERE type='movie' ORDER BY serial_no");
$count = mysqli_num_rows($result);

function fmtDateM($d){ if(!$d) return '—'; return date('d/m/Y', strtotime($d)); }
?>
<style>
.report-header {
    display: flex;
...
<div class="container-fluid py-4 px-4" style="max-width:1200px;">
    <div class="report-header">
        <h4><i class="fas fa-film me-2" style="color:#00b894;"></i>Master List of Movies</h4>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><?php echo $i++; ?></td>
                        <td><code style="background:#eef1f5; padding:3px 10px; border-radius:6px; font-weight:600; color:#00b894;"><?php echo $row['serial_no']; ?></code></td>
                        ...
                        <td><?php echo fmtDateM($row['procurement_date']); ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
    ...
    <div class="card-custom p-5 text-center">
        ...
        <p class="text-muted">No movies found in the library.</p>
    </div>
    <?php } ?>
